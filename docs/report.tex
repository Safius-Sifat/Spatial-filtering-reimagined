...
\usepackage{listings}
\usepackage{enumitem}
\usepackage[round]{natbib}   % author-year-style citation hooks
\bibliographystyle{ieeetr}  % numeric style: [1], [2], ...
...
\begin{figure}[H]
\centering
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\linewidth]{fluo_gowt1_sample_256.png}\caption{Original}\label{fig:fluo_orig}\end{subfigure}\hfill
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\linewidth]{fluo_gowt1_realistic_noisy.png}\caption{Noisy (realistic)}\label{fig:fluo_noisy}\end{subfigure}\hfill
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\linewidth]{fluo_gowt1_realistic_Box_3x3.png}\caption{Box 3$\times$3}\label{fig:fluo_box}\end{subfigure}
...
\begin{figure}[H]
\centering
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\linewidth]{fluo_gowt1_realistic_Median_3x3.png}\caption{Median 3$\times$3}\end{subfigure}\hfill
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\linewidth]{fluo_gowt1_realistic_AVGF_Custom.png}\caption{AVGF (custom)}\end{subfigure}\hfill
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\linewidth]{fluo_gowt1_realistic_NGKCS_Custom.png}\caption{NGKCS (custom)}\end{subfigure}
...
\begin{figure}[H]
\centering
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{fluo_gowt1_sample_256.png}\caption{Original}\end{subfigure}\hfill
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{fluo_gowt1_realistic_noisy.png}\caption{Noisy (realistic)}\end{subfigure}\hfill
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{fluo_gowt1_realistic_Box_3x3.png}\caption{Box 3$\times$3}\end{subfigure}\hfill
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{fluo_gowt1_realistic_Median_3x3.png}\caption{Median 3$\times$3}\end{subfigure}
\\[2pt]
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{fluo_gowt1_realistic_AVGF_Custom.png}\caption{AVGF (custom)}\end{subfigure}\hfill
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{fluo_gowt1_realistic_Sobel_Sharpen.png}\caption{Sobel sharpen}\end{subfigure}\hfill
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{fluo_gowt1_realistic_Unsharp_Mask.png}\caption{Unsharp mask}\end{subfigure}\hfill
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{fluo_gowt1_realistic_NGKCS_Custom.png}\caption{NGKCS (custom)}\end{subfigure}
...
\begin{figure}[H]
\centering
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\linewidth]{bbbc005_sample_256.png}\caption{Original}\end{subfigure}\hfill
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\linewidth]{bbbc005_mask_256.png}\caption{Ground-truth mask}\end{subfigure}\hfill
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\linewidth]{bbbc005_heavy_noisy.png}\caption{Noisy (heavy)}\end{subfigure}
...
\begin{figure}[H]
\centering
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\linewidth]{bbbc005_heavy_Box_3x3.png}\caption{Box 3$\times$3}\end{subfigure}\hfill
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\linewidth]{bbbc005_heavy_Median_3x3.png}\caption{Median 3$\times$3}\end{subfigure}\hfill
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\linewidth]{bbbc005_heavy_AVGF_Custom.png}\caption{AVGF (custom)}\end{subfigure}
...
\begin{figure}[H]
\centering
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{bbbc005_sample_256.png}\caption{Original}\end{subfigure}\hfill
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{bbbc005_heavy_noisy.png}\caption{Noisy (heavy)}\end{subfigure}\hfill
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{bbbc005_heavy_Box_3x3.png}\caption{Box 3$\times$3}\end{subfigure}\hfill
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{bbbc005_heavy_Median_3x3.png}\caption{Median 3$\times$3}\end{subfigure}
\\[2pt]
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{bbbc005_heavy_AVGF_Custom.png}\caption{AVGF (custom)}\end{subfigure}\hfill
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{bbbc005_heavy_Sobel_Sharpen.png}\caption{Sobel sharpen}\end{subfigure}\hfill
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{bbbc005_heavy_Unsharp_Mask.png}\caption{Unsharp mask}\end{subfigure}\hfill
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{bbbc005_heavy_NGKCS_Custom.png}\caption{NGKCS (custom)}\end{subfigure}
...
\begin{figure}[H]
\centering
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\linewidth]{bbbc034_sample_256.png}\caption{Original}\end{subfigure}\hfill
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\linewidth]{bbbc034_realistic_noisy.png}\caption{Noisy (realistic)}\end{subfigure}\hfill
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\linewidth]{bbbc034_realistic_Box_3x3.png}\caption{Box 3$\times$3}\end{subfigure}
...
\begin{figure}[H]
\centering
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\linewidth]{bbbc034_realistic_Median_3x3.png}\caption{Median 3$\times$3}\end{subfigure}\hfill
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\linewidth]{bbbc034_realistic_AVGF_Custom.png}\caption{AVGF (custom)}\end{subfigure}\hfill
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\linewidth]{bbbc034_realistic_NGKCS_Custom.png}\caption{NGKCS (custom)}\end{subfigure}
...
\begin{figure}[H]
\centering
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{bbbc034_sample_256.png}\caption{Original}\end{subfigure}\hfill
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{bbbc034_realistic_noisy.png}\caption{Noisy (realistic)}\end{subfigure}\hfill
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{bbbc034_realistic_Box_3x3.png}\caption{Box 3$\times$3}\end{subfigure}\hfill
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{bbbc034_realistic_Median_3x3.png}\caption{Median 3$\times$3}\end{subfigure}
\\[2pt]
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{bbbc034_realistic_AVGF_Custom.png}\caption{AVGF (custom)}\end{subfigure}\hfill
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{bbbc034_realistic_Sobel_Sharpen.png}\caption{Sobel sharpen}\end{subfigure}\hfill
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{bbbc034_realistic_Unsharp_Mask.png}\caption{Unsharp mask}\end{subfigure}\hfill
\begin{subfigure}{0.235\textwidth}\includegraphics[width=\linewidth]{bbbc034_realistic_NGKCS_Custom.png}\caption{NGKCS (custom)}\end{subfigure}
...
\item R.~C. Gonzalez and R.~E. Woods, \emph{Digital Image Processing}, 4th ed., Pearson, 2018.
\item T.~S. Huang, \emph{Image Sequence Analysis}, Springer, 1979 (median filter reference).
\item I.~Sobel, ``Camera models and machine perception,'' Stanford A.I. Memo, 1970.
\item J.-S. Lee, ``Digital image enhancement and noise filtering by use of local statistics,'' \emph{IEEE TPAMI}, vol.~PAMI-2, no.~2, pp.~165--168, 1980.
\item C.~Tomasi and R.~Manduchi, ``Bilateral filtering for gray and color images,'' in \emph{ICCV}, 1998, pp.~839--846.
\item R.~Kirsch, ``Computer determination of the constituent structure of biological images,'' \emph{Computers and Biomedical Research}, vol.~4, no.~3, pp.~248--256, 1971.
\item J.~Immerkær, ``Fast noise variance estimation,'' \emph{CVGIP: Graphical Models and Image Processing}, vol.~58, no.~3, pp.~300--302, 1996.
\item F.~Sattar, L.~Floreby, G.~Salomonsson, and B.~Lovstrom, ``Image enhancement based on a nonlinear multiscale method,'' \emph{IEEE Trans. Image Processing}, vol.~6, no.~6, 1997 (EPI definition).
\item W.~K. Pratt, \emph{Digital Image Processing}, Wiley, 1978 (Figure of Merit).
\item Z.~Wang, A.~C. Bovik, H.~R. Sheikh, and E.~P. Simoncelli, ``Image quality assessment: from error visibility to structural similarity,'' \emph{IEEE Trans. Image Processing}, vol.~13, no.~4, pp.~600--612, 2004.
\item M.~Lebrun and J.-M. Morel, ``A Poisson--Gaussian noise model for image denoising,'' \emph{Journal of Mathematical Imaging and Vision}, vol.~53, no.~3, pp.~263--283, 2015.
\item BBBC005 image set, Broad Bioimage Benchmark Collection. \url{https://bbbc.broadinstitute.org/BBBC005}
\item Fluo-N2DH-GOWT1 dataset, Cell Tracking Challenge. \url{https://celltrackingchallenge.net/2d-datasets/}
\item BBBC034 image set, Broad Bioimage Benchmark Collection. \url{https://bbbc.broadinstitute.org/BBBC034}
\item ``Project Specification: Deep Investigation and Custom Design of Spatial Filters,'' CSE 4106 course handout.
\end{enumerate}
